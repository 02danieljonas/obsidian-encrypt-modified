...
export class CryptoHelper {
    ...
    public async useSinglePassword(password: string): Promise<void> {}
    ...
    public async encryptToBytes(
        ...
        const finalBytes = new Uint8Array(
            vector.byteLength + encryptedBytes.byteLength
        );
    ...
    public async decryptFromBase64(
